...
# Update OpenSSL config to include oqsprovider
...
# Set the environment variables for OpenSSL to use oqsprovider
ENV OPENSSL_CONF=$BUILD_DIR/ssl/openssl.cnf
ENV OPENSSL_MODULES=$BUILD_DIR/lib

# Verify that oqsprovider is available in OpenSSL
